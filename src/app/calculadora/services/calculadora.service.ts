 ...
 * calculadora.
 * 
 * @author Igor Vilneck<igvilneck@gmail.com>
 * @since 1.0.0
 */
...
export class CalculadoraService {
  ...
  static readonly EXPONENCIAL: string = '^';
  static readonly RAIZ_QUADRADA: string = 'sqrt';
   ...
   calcular(num1: number, num2: number, operacao: string): number {
  	...
  	switch(operacao) {
  	  ...
  	  case CalculadoraService.MULTIPLICACAO:
  	    resultado = num1 * num2;
  		break;
  	  case CalculadoraService.EXPONENCIAL:
  	    resultado = num1 ** num2;
  		break;
  	  case CalculadoraService.RAIZ_QUADRADA:
